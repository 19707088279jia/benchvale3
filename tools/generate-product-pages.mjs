...
const footer = (depth = "") => `<footer class="site-footer"><div class="container"><div class="footer-grid"><div><span class="footer-brand-name">ChromVale Scientific</span><p>Laboratory Products &amp; Equipment</p><p>Ontario, Canada</p></div><div><span class="footer-heading">Contact</span><ul><li><a href="mailto:eric@benchvalescientific.com">eric@benchvalescientific.com</a></li><li><a href="mailto:quotes@benchvalescientific.com">quotes@benchvalescientific.com</a></li></ul></div><div><span class="footer-heading">Navigate</span><ul><li><a href="${depth}products.html">Products</a></li><li><a href="${depth}equipment.html">Equipment</a></li><li><a href="${depth}sourcing.html">Sourcing</a></li><li><a href="${depth}about.html">About</a></li><li><a href="${depth}contact.html">Contact</a></li><li><a href="${depth}shipping.html">Shipping</a></li><li><a href="${depth}returns.html">Returns &amp; RMA</a></li><li><a href="${depth}warranty.html">Warranty</a></li><li><a href="${depth}terms.html">Terms</a></li><li><a href="${depth}privacy.html">Privacy</a></li></ul></div></div><div class="footer-bottom"><span>&copy; 2026 ChromVale Scientific</span><span><a href="${depth}terms.html">Terms</a> · <a href="${depth}privacy.html">Privacy</a></span></div></div></footer>`;
...
<body class="products-page">
  ...
  <main id="main">
    ...
    <section class="catalogue-help"><div class="container catalogue-help-inner"><div><p class="eyebrow">Need a different configuration?</p><h2>Tell us the specifications that matter</h2><p>ChromVale can review a preferred manufacturer or Cat.No., required documentation, pack size, quantity, postal code, and required date.</p></div><a href="quote.html" class="btn btn-primary">Start an RFQ</a></div></section>
  </main>
...
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>${escapeHtml(product.name)} | ChromVale Scientific</title>
  <meta name="description" content="${escapeHtml(product.description)} Request a quote from ChromVale Scientific." />
  <link rel="canonical" href="${canonical}" />
  <meta property="og:type" content="product" />
  <meta property="og:title" content="${escapeHtml(product.name)} | ChromVale Scientific" />
  <meta property="og:description" content="Product information and quote request from ChromVale Scientific." />
