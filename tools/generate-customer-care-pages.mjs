...
const pages = [
  {
    ...
    description: "How ChromVale Scientific confirms availability, destination, freight requirements, and delivery details for laboratory products and equipment.",
    ...
    sections: [
      ["Quote-stage review", ["ChromVale confirms supplier availability and the order configuration before presenting shipping information.", "The quotation identifies the shipping assumptions available at that stage. Changes to quantity, destination, access, or timing may require a revised quote."]],
  ...
  },
  {
    ...
    description: "ChromVale Scientific return and RMA framework for laboratory products and equipment.",
    ...
    sections: [
      ["Start with an assessment", ["Email eric@benchvalescientific.com with the order reference, product, quantity, reason for the request, and relevant photos or technical observations.", "For suspected equipment failure, ChromVale may first request troubleshooting information so the probable cause and appropriate support route can be assessed."]],
  ...
  },
  {
    ...
    description: "ChromVale Scientific warranty framework, including potentially covered defects, normal exclusions, troubleshooting, assessment, and RMA.",
    intro: "Warranty terms vary by manufacturer, supplier, and product. ChromVale does not publish or imply a universal warranty period; the applicable term must be confirmed in the quotation, order documentation, or verified manufacturer material.",
    sections: [
  ...
  },
  {
    ...
    description: "Terms for using the ChromVale Scientific website and requesting quotations for laboratory products and equipment.",
    ...
    sections: [
      ["Product information", ["ChromVale publishes verified manufacturer details where they are available and clearly marks supplier-dependent information as “Manufacturer model pending” or “Under supplier confirmation.”", "Product images, descriptions, and category records support inquiry and comparison. The applicable manufacturer model, Cat.No., specifications, pack size, documents, availability, shipping, warranty, and commercial terms must be confirmed in the quotation before purchase.", "No certification, sterility claim, document, model number, Cat.No., warranty period, or price should be inferred when it is not expressly stated."]],
      ["Pricing", ["Public selling prices are not currently published. Product pages display “Request a Quote.”", "ChromVale reviews supplier cost, logistics, and comparable Canadian market information before presenting a selling price. Quotes may include stated assumptions, validity, taxes, shipping, and other product-specific terms."]],
      ["RFQs and orders", ["The RFQ form prepares an email on the user's device and does not submit information to a ChromVale web server.", "An RFQ is a request for information and pricing, not an acceptance, purchase order, or reservation of stock.", "No product is ordered until the laboratory has reviewed the applicable specifications and commercial terms and ChromVale has received written approval or an accepted order through the agreed process."]],
      ["Availability and substitutions", ["Catalogue presence does not indicate stock. Availability, lead time, minimum order quantity, and supplier status are confirmed at quote stage.", "ChromVale will not knowingly substitute a materially different product without presenting the relevant information for review."]],
...
<head>
  ...
  <title>${escapeHtml(page.eyebrow)} | ChromVale Scientific</title>
  <meta name="description" content="${escapeHtml(page.description)}" />
  <link rel="canonical" href="https://chromvale.com/${page.slug}.html" />
  <meta property="og:type" content="website" /><meta property="og:title" content="${escapeHtml(page.eyebrow)} | ChromVale Scientific" /><meta property="og:description" content="${escapeHtml(page.description)}" /><meta property="og:url" content="https://chromvale.com/${page.slug}.html" />
...
<body>
  ...
  <footer class="site-footer"><div class="container"><div class="footer-grid"><div><span class="footer-brand-name">ChromVale Scientific</span><p>Laboratory Products &amp; Equipment</p><p>Ontario, Canada</p></div><div><span class="footer-heading">Contact</span><ul><li><a href="mailto:eric@benchvalescientific.com">eric@benchvalescientific.com</a></li><li><a href="mailto:quotes@benchvalescientific.com">quotes@benchvalescientific.com</a></li></ul></div><div><span class="footer-heading">Navigate</span><ul><li><a href="products.html">Products</a></li><li><a href="equipment.html">Equipment</a></li><li><a href="sourcing.html">Sourcing</a></li><li><a href="about.html">About</a></li><li><a href="contact.html">Contact</a></li><li><a href="quote.html">Request a Quote</a></li><li><a href="shipping.html">Shipping</a></li><li><a href="returns.html">Returns &amp; RMA</a></li><li><a href="warranty.html">Warranty</a></li><li><a href="terms.html">Terms</a></li><li><a href="privacy.html">Privacy</a></li></ul></div></div><div class="footer-bottom"><span>&copy; 2026 ChromVale Scientific</span><span><a href="terms.html">Terms</a> · <a href="privacy.html">Privacy</a></span></div></div></footer>
